:: Note from Gameless: Don't run scripts before knowing what it does.
:: Added: Connect4 logo, sizing of box, editted instructions, changed some formatting/spacing
@echo off&setlocal&color 0e&mode con cols=50 lines=20
title Connect Four By Mastahhaxor, Edit by Gameless
color 1A
:titlescreen
color 0A
cls
...
Echo By Mastahhaxor, Edit by Gameless
Echo.
Echo.
Echo 1)Play Game
Echo 2)Instructions
...
:instruct
cls
Echo&setlocal&color 03&mode con cols=75 lines=20
Echo.
...
:superstart
color 0E&mode con cols=22 lines=10
cls
Echo.
Echo.
...
:map1
cls
Echo&mode con cols=25 lines=20
Echo.
Echo.
Echo.
Echo   A   B   C   D   E   F
...
:winx
cls
color 0C&mode con cols=40 lines=10
set /a scorex=%scorex%+1
Echo.
Echo.
Echo Congrats %xs%, You Won!
Echo.
Echo.
Echo.
Echo.
...
Echo.
Echo.
Echo Sorry %xs% and %os%, but it's a draw!
Echo.
Echo.
Echo.
Echo.
